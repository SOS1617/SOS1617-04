app.controller("ListCtrl", ["$scope", "$http", function($scope, $http) {
    ...
    function refresh() {
        $http
            .get("api/v1/area-and-production"+$scope.apikey)
    ...
    $scope.addStat = function() {
        $http
            .post("api/v1/area-and-production"+$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.update = function(province, year) {
        $http
            .put("api/v1/area-and-production/" + province + "/" + year+$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.loadInitial = function() {
        $http
            .get("api/v1/area-and-production/loadInitialData"+$scope.apikey)
            .then(function(response) {
    ...
    $scope.deleteStat = function(province, year) {
        $http
            .delete("api/v1/area-and-production/" + province + "/" + year +$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.deleteAll = function() {
        $http
            .delete("api/v1/area-and-production"+$scope.apikey)
            .then(function(response) {
