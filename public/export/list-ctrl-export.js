app.controller("ListCtrl", ["$scope", "$http", function($scope, $http) {
    ...
    function refresh() {
        $http
            .get("api/v1/export-and-import"+$scope.apikey)
    ...
    $scope.addStat = function() {
        $http
            .post("api/v1/export-and-import"+$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.update = function(province, year) {
        $http
            .put("api/v1/export-and-import/" + province + "/" + year+$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.loadInitial = function() {
        $http
            .get("api/v1/export-and-import/loadInitialData"+$scope.apikey)
            .then(function(response) {
    ...
    $scope.deleteStat = function(province, year) {
        $http
            .delete("api/v1/export-and-import/" + province + "/" + year +$scope.apikey, $scope.newStat)
            .then(function(response) {
    ...
    $scope.deleteAll = function() {
        $http
            .delete("api/v1/export-and-import"+$scope.apikey)
            .then(function(response) {
